  ...
  return common_vendor.e({
    ...
    b: common_vendor.f($data.data, (item, index, i0) => {
      return {
        ...
        c: "6280423d-2-" + i0 + "," + ("6280423d-1-" + i0),
        d: common_vendor.p({
          title: $data.compounds[index]
        }),
        e: "6280423d-1-" + i0 + "," + ("6280423d-0-" + i0),
        f: index,
        g: "6280423d-0-" + i0,
        h: common_vendor.p({
          title: item.name,
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "C:/Users/chen2/Documents/HBuilderProjects/FoodCheck/pages/user-info/record/record.nvue"]]);
