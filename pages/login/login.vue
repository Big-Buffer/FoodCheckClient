<template>
	<view class="login-register">
		...
		<view class="button-login">
			<button v-show="form.mobile && form.code" type="success" @click="phoneLogin" shape="circle">登录</button>
			<button v-show="!form.mobile || !form.code" type="default" shape="circle">登录</button>
		</view>
	</view>
</template>
